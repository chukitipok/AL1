...
namespace _02.HelloPolymorphisme
{
    ...
    public class MockClockService : IClockService
    {
        ...
        public DateTime Now() => _dateTimeToReturn;
    }
    ...
    public class Lesson
    {
        private readonly DateTime _lessonStartDateTime;
        ...
        {
            return clockService.Now() - _lessonStartDateTime > TimeSpan.FromMinutes(90); 
        }
    }
